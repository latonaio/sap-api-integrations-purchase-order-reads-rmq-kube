...
import (
	...
	"io/ioutil"
	"net/http"
	sap_api_output_formatter "sap-api-integrations-purchase-order-reads-rmq-kube/SAP_API_Output_Formatter"
	"strings"
	"sync"
...
func (c *SAPAPICaller) Header(purchaseOrder string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": itemData, "function": "PurchaseOrderItem"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": itemScheduleLineData, "function": "PurchaseOrderItemScheduleLine"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": itemPricingElementData, "function": "PurchaseOrderItemPricingElement"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": itemAccountData, "function": "PurchaseOrderItemAccount"})
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) ItemScheduleLine(purchasingDocument, purchasingDocumentItem string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": data, "function": "PurchaseOrderItemScheduleLine"})
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) ItemPricingElement(purchaseOrder, purchaseOrderItem string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": data, "function": "PurchaseOrderItemPricingElement"})
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) ItemAccount(purchaseOrder, purchaseOrderItem string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": data, "function": "PurchaseOrderItemAccount"})
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) PurchaseRequisition(purchaseRequisition, purchaseRequisitionItem string) {
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": data, "function": "PurchaseOrderItem"})
	if err != nil {
		c.log.Error(err)
		return
	}
